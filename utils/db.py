...
df = pd.DataFrame(data, columns=["DATE", "DEPARTMENT_NAME", "PRODUCTIVE_HOURS", "OVERHEAD_HOURS", "TOTAL_HOURS", "OVERHEADS_PER_PRODUCTIVE", "ARTISTS", "FILESIZE_PRODUCTIVITY", "COUNT_PRODUCTIVITY", "REVIEW_PRODUCTIVITY", "AVG_WAITTIME"])
